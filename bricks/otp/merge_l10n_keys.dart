...
void main() async {
  ...
  final keysEn = await readKeysFile('$scriptDir/l10n/otp_l10n.arb');
  final keysHans = await readKeysFile('$scriptDir/l10n/otp_l10n_zh_Hans.arb');
  final keysHant = await readKeysFile('$scriptDir/l10n/otp_l10n_zh_Hant.arb');
